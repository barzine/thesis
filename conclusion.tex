...
particularly when the resources are outdated, such as \gls{TIGER}~\mycite{tiger}.
...
Even though we mapped both the proteomics and transcriptomics
to the same genome and its annotation versions,
...
While I lack to provide an extensive view of
the impact of the combinations of the different parameters,
...
Finally, the velocity with which new data was available
compared to the time required
to prepare and then include it in my on-going analyses was
unappealing and impracticable.
