...
to $0.47$ for the \tissue{Oesophagus}.
\rough{If I exclude the lowly correlated genes
...
When I realise the previous comparison for the other 14 tissues, the results are
quite similar (see \cref{fig:IndScatt}). To test the significance of these
