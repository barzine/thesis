...
\begin{figure}[!htbp]
    \includegraphics[scale=0.65]{integration/PandeyGtexUhlen_tissuesVenn.png}\centering
...
\begin{figure}[!htbp]
    \includegraphics[scale=0.65]{integration/KusterGtexUhlen_tissuesVenn.png}\centering
...
expression. On the other hand, the \dataset{Uhlén \etal} have \emph{technical} and
...
(between \dataset{Pandey \etal} and \dataset{Uhlén \etal} data and betwween
\dataset{Pandey \etal} and \dataset{Gtex}), I have done the bulk of the analyses
...
for the processing methods) for \dataset{Uhlén \etal} and \dataset{Gtex} datasets.
