...
I have selected to perform two enrichment analyses,
namely a \glsdesc{gsea} (\gls{gsea}) and a \glsdesc{goa} (\gls{goa})
(respectively described in
\Cref{sec:gseaPresentation} and \Cref{sec:goaGeneralities}).
...
\begin{landscape}
    \begin{figure}
        \includegraphics[scale=1]{integration/gsea.pdf}\centering
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%Relative approach
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%(in contrast of the absolute one based on correlation values)
