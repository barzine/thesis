...
%Ripped from background chapter:
To date, the existence of a given \mRNA\ transcript and its concentration
are insufficient to ensure detection of the protein in a sample.
While many regulations processes may occur after the creation of a \mRNA{},
