...
\section{Influence of the expression breadth on the tissue %
...
\section{Tissue specific \texorpdfstring{\MakeLowercase{m}RNAs}{mRNAs} %
...
suggesting that the \gls{TS} genes content of each tissue is insufficient
to explain the correlation level between its proteome and transcriptome.
...
between the proteome and transcriptome of each tissue,
\gls{TS} proteins and \mRNAs\ are insufficient to explain
the overall relationship between their expression.


\section{Gene centric studies}

As I exposed in~\Cref{ch:Transcriptomics}, there are some
\mRNAs\ that are lowly or even anticorrelated between the different
