...
A few closely related studies~\mycite{SciRep2016,Franks2017-bp,Eraslan2019-md} have
...
Another study based on mouse immune genes~\mycite{Jovanovic2015-wv} has identified
...
Correlations are dependent on the identified and quantified molecules.
Their respective stability has a direct impact on their measurement.
\citet{Vogel2012-sq}'s review reports several papers
--- including \citet{schwanhausserglobal:2011} ---
that have observed a higher expression stability for
...
%organ metabolic profile ~\mycite{Berg2002-vo}.



Catabolic processes are an energy release source and
depend on molecules requiring to be break down~\mycite{molBiolCell}.
The previous results suggest that
cells transpose the expression of the related \mRNAs\
into proteins with minimal post-transcription or post-translation regulation.
Most probably, the presence and concentration of the molecules to be catabolised
are the main regulators of these processes.
The high protein-per-mRNA ratios observed
for mammalian metabolic genes~\mycite{Vogel2010-ux}
contributes to this hypothesis plausibility.

On the other hand, the anticorrelation of regulation genes indicates that
they are most probably highly regulated themselves.
However, other possible biological explanations exist,
including higher translation rates,
higher quality controls than other proteins
since they are key players of the cell machinery,
or their \mRNA\ concentration exerts a negative feedback loop
on their own transcription.\mybr\


The anticorrelated pairs may also results of technical artefacts.
...
Normalisation methods for \Rnaseq\ require the gene or transcript length
(see \Cref{subsub:norm}).
I chose to perform all the analyses at gene level expression
(see p.~\pageref{minisec:quantNorm})
since for each gene there are various \mRNA\ isoforms~\mycite{MarPhD}
and proteoforms~\mycite{Aebersold2018-jn}.
Moreover, many inconsistencies for their quantifications exist
between methods, platforms and studies~\mycite{Dapas2017-ui,Aebersold2018-jn}.
An example of oft-neglected sources is the genes length.
...
gracioulsy these gene lengths computed in this manner.
...
This ought to be rather easy to implement,
