...
%\vspace{4mm}
Given the \cpv{mixed results} of the direct approaches built on uniquely detected genes,
...
\softCi{ape \normalfont{(v5.3)}}{Paradis2019-ue}.\mybr\
...
\begin{figure}[!htb]
    \includegraphics[scale=0.9]{integration/PearsonLog2correlationRankedGenes3_15meanPermut.png}\centering
    \vspace{-3mm}
...
\begin{figure}[!ht]
    \includegraphics[scale=0.88]{integration/TSratioBasedOnPearsoncorrelationRankedGenes3_15SimulrowMeans.png}\centering
    \vspace{-3mm}
...
%\begin{landscape}
    \begin{sidewaysfigure}
        \includegraphics[scale=0.91]{integration/goea.png}\centering
        \vspace{-3mm}
...
present \cpv{reasonable} correlation coefficients.
...
Most remarkably,
all the same-tissue pairs of \cpv{transcriptome and proteome}
...
current algorithms' accuracy with isoforms~\mycite{tamaraRNA,Janes2015-wn,Dapas2017-ui}.\mybr\
