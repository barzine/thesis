...
\begin{figure}%[!htbp]
\includegraphics[scale=0.8]{integration/expressedOrNot2.pdf}\centering
    \caption[Expressed or not: several cases illustrated]
    {\label{fig:DefineExpression}\textbf{Expressed or not: several cases
    illustrated.} \\Genes as \emph{gene 1} are unequivocal: they have been
...
\subsubsection{Expressed transcript}\KOMAoptions{parskip=half*}
...
tissues.}\\The tissues are ordered by their number of different proteins they
...
\begin{figure}%[!htbp]
     ...
     \caption[Number of \mRNAs\ and proteins detected (at specific thresholds)
     only in one unique tissue]{\label{fig:barPlotunique} \textbf{Number of
...
\begin{figure}
    \includegraphics[scale=0.75]{integration/GeneProtCor}\centering
