...
%\vspace{-4mm}
\begin{figure}[!htbp]
     \includegraphics[scale=0.8]{integration/overviewDatasets.pdf}\centering
     \vspace{-3mm}
...
and many of the highest measured \mRNAs{}.\mybr\
...
Although the number of genes affected by the dispersion is rather limited,
...
%\vspace{-8mm}
\begin{figure}[!hb]
    \includegraphics[scale=0.85]{integration/orderedHeatmapQ3Pearson.pdf}\centering
    \vspace{-2mm}
...
or expressed in all fifteen of them.\mybr\
...
\begin{minipage}{\textwidth}
    The Jaccard index for the generic case shown in \Cref{fig:RankSpe}
...
which include the comparison of \gls{TS} genes for \tissue{Urinary} \bladder\
...
by linking the tissues with Ward's method~\mycite{Ward1963}
as in the previous analyses.\mybr\
...
in \Cref{fig:heatmapPandeyTissuePairs,fig:heatmapUhlenTissuePairs05}.\mybr\
...
\Testis\ and \Ovary, \Rectum\ and \hColon\ and \Liver\ and \Kidney.\mybr\
...
as most closely related: \Testis\ and \Ovary, and \Liver\ and \Kidney.\mybr\
...
including \Rectum\ and \hColon\ or \Pancreas\ and \Gall{}.\mybr\

These observations are of interest in the light of the results
presented in \Cref{subsec:mrnaHighExp}
...
whose \mRNA\ and protein expression levels are tightly related.\mybr\
...
and \mRNA/\mRNA\ pairs in green are providing some context.\mybr\
...
other, less correlated, genes may need more context.\mybr\
...
for their integration and comparison.\mybr\
...
The standard use of the Spearman correlation in the literature
...
is favoured over comparing their linearity by Pearson correlation.\mybr\

The new \PPKM\ quantification method for proteins,
presented in \Cref{ch:proteomics},
produces protein expression levels
that present similar profiles to the transcriptomics (see \Cref{ch:expression}).
...
have a statistically significant correlation.\mybr\
...
Even though \mRNAs\ and proteins expression breadth distributions can share
...
Unfortunately, this analysis fails to explain
...
their correlation ranges rather widely ($-0.77 ≤ r≤ 1$).\mybr\
...
any biological or technical reasons.\mybr\
...
and the most anticorrelated ones with regulation processes.\mybr\
...
to inter-individual variation and batch effects.\mybr\
...
and are less subject to technical noise.\mybr\
...
Other biological or biochemical reasons may also be at play.\mybr\
...
for mammalian metabolic genes~\mycite{Vogel2010-ux} tend
to back the more limited regulation for the catabolic genes.\mybr\
...
further studies may identify specific catabolic signatures for each tissue.\mybr\
...
by peri-transcriptional and posttranslational mechanisms.\mybr\
...
on their identical distribution of \mRNAs\ and proteins.\mybr\

Focusing on the most tissue-specific (\gls{TS}) proteins and \mRNAs\
may give mixed results,
but it also appears more efficient than the highest expressed \mRNAs\ and proteins.\mybr\
...
that appear associated with the regulation processes.\mybr\

At the moment, much effort is dedicated
...
but above all,
prove their reproducibility by including several data resources.\mybr\
...
before tackling more and more complex ones.\mybr\
...
that I provide as digital supplementary data may offer a promising basis
for highlighting new associations and improving current gene annotations.\mybr\
