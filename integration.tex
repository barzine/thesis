...
\Cref{fig:PGU_vennQ1} presents the overlap of genes
whose expression was detected
both as a protein in the \pandey\ Lab data quantified 
through the pipeline described in \Cref{subsec:msDataProcess}
and as an \mRNAs\ in \uhlen\ \etal\ and \gtex\ data quantified by \htseq\
(see \Cref{subsubsec:RnaseqDataProc}) across their twelve shared tissues.
...
\Cref{fig:PU_vennQ1} is a replication of \Cref{fig:PGU_vennQ1}
...
\begin{figure}[!ht]
    \includegraphics[scale=0.62]{integration/PandeyGtexUhlen_mRNAprotQ3Vennm.pdf}\centering
    \vspace{-4mm}
...
\begin{figure}[!ht]
    \includegraphics[scale=0.62]{integration/PandeyUhlen_mRNAprotQ3Vennm.pdf}\centering
    \vspace{-4mm}
