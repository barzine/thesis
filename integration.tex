...
quantified with our \PPKM\ quantification (see \Cref{ch:proteomics}).
...
\begin{itemize}[topsep=0pt,nosep]
        \item saturation effect of more abundant proteins
            (see \Cref{subsec:simpleProt})
        \item degenerate peptides (see \Cref{subsec:proteinInference}),
        \item quantification inconsistencies between methods,
            platforms and studies~\mycite{Dapas2017-ui,Aebersold2018-jn},
        \item annotation,
        \item or other oft-neglected sources, \eg{}: gene or isoform length.
\end{itemize}
...
Some genes displaying mixed correlation in my analyses may present
...
On the other hand,
the highly correlated (or anticorrelated) pairs highlighted in this thesis
...
%The study is a follow-up to a series of studies,
%all conducted on the same set of human tissues samples
%by the Department of Pathology,
...
The proteomic data can be retrieved in \Pride{\href{https://www.ebi.ac.uk/pride/archive/projects/PXD010154/}{PXD010154}} ---
...
--- described in their previous paper~\mycite{Uhlen2015}
and which I am using in this thesis, including this chapter.
...
I suspect this last point is mostly rather a confirmation of the success
...
Hence, both \mRNA\ and protein stabilities impact the quantification directly,
and, therefore, their correlation too.
\citet{Vogel2012-sq} review several papers
--- including \citet{schwanhausserglobal:2011} ---
that observe higher expression stability for
...
While the relative stability may be the sole reason behind these observations,
other biological and biochemical reasons may also be at play.\mybr\
