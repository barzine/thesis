...
\minisec{Specificity of the \emph{paired-end} protocol}
...
\subsubsection[Data analysis overview]{Data analysis overview (\ie\ a typical
bioinformatic workflow for \Rnaseq\ study)}
...
Protein identification and quantification rely on \ms\ as the method of choice
since it allies high-throughput 
