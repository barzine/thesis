...
Desalting steps usually include solvent precipitations. They are
very easy to perform and they usually involve solvent gradients. However,
their use is limited with protein mixtures as other separation methods,
...
Thus, the sequential use of a gel and then \gls{LC} separation allows to
fraction efficiently unknown mixtures into simpler ones ready to be analysed with
\ms.

Moreover, \gls{LC} modules are easily coupled to mass spectrometers. In addition,
to present the components in an adequate form to be ionised, a detector monitoring
the \gls{LC} will optimise the \ms\ analyses as it will initiate them at relevant
times. Before being used in proteomics, \gls{LC-MS/MS} was already a
very powerful and widespread chemical analysis method.
...
spectrometer which he uses for his paper \paper{\citetitle{Aston1919}}
\mycite{Aston1919}. \ms\ became rapidly a pillar
...
proteomics pipelines \mycite{Chen2016}.

\subsubsection{Identification of peptides and proteins}
