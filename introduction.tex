...
This theory still holds true
even though the truth is not as linear as first thought.
It also explains why the assumptions of strong correlations between the \mRNA\
and the protein levels of a gene have lasted (are still lasting) so long.

\begin{figure}%[!htbp]
    \includegraphics[scale=0.45]{introduction/dogma}\centering
...
\TK{add references, see TAC report 3}
