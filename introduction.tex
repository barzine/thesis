...
a SAM/BAM file to keep the \emph{unambiguous} ones only. Then, it counts their
...
GTF or GFF format) to a specific reference (genome or transcriptome).}.
...
insignificant. Interestingly, many papers (\eg\ \mycite{Fonseca2014},
