...
\glsentrydesc{Bottom-up}}\sepfootnote\footnote{In
fact, \gls{Top-down} approaches while appealing are still very challenging both
as experimental and computational perspectives \mycite{AebersoldMann2016}.}
for identification and quantification studies; this method is also
called \emph{\enquote{shotgun}} proteomics \mycite{Cox2011}. The bottom-up
approach\footnote{First introduced by \cite{Hunt1992}} increased popularity
relies on the availability of high-quality genome and gene sequence databases
and more recent technical advances in \ms, in particular the discovery
and development of protein ionization methods and fragmentation
\mycite{Aebersold2003}.


\subsection{Sample preparation}

\TK{preparation of the sample}
Unfortunately, proteomics field lacks amplification methods such as \gls{PCR}.
Thus, the quantity of proteins detected is directly
