...
Indeed, these peptide-mass fingerprints are a very effective way to identify
...
While there are other ionisation methods (more adapted to small organic molecules)
there are two that are use routinely for proteomic samples: \gls{ESI} and
\gls{MALDI}.
