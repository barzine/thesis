...
\begin{enumerate}
    \item \emph{Initialisation}: Based on these different piece of information, a rough
    estimation of the probable probability of each fragment being expressed
    by each compatible isoform is computed.
\item \emph{Iteration till convergence}:
    \begin{enumerate}
...
insignificant \mycite{htseq}. Interestingly, many papers (\eg\ \cite{Fonseca2014},
...
%\minisec{Examples of downstream analysis}\label{minisec:dgea}
