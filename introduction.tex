...
\gls{flow}\footnote{\Rnaseq\ lacks to assess directly the initial \gls{RNA}
abundance of a sample from the initial collection
...
tend to a more optimal amplification.}. A few of them may correct
\emph{batch effect} (see \cref{sec:expDesign}) or other confouding factors.
The \gls{BiocR} package \soft{RUVSeq} \mycite{ruvseq} is one of the example.
