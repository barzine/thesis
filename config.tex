%\RequirePackage{minted} %remove as no more code in the thesis
...
maxcitenames=1,maxbibnames=99,useprefix,uniquename=init,
labeldate=year,alldates=year,urldate=short%,sortlocal=en-GB%
%,backref%
]{biblatex} %add backref for draft
...
\setlength{\glsdescwidth}{0.98\textwidth}
\renewcommand*{\glossarypreamble}{\vspace*{-10pt}}
\makeglossaries%
%\loadglsentries{glossary.tex}

\RequirePackage{scrhack} %to avoid some possible reported clashes
...
\RequirePackage[markifdraft]{gitinfo2}
\RequirePackage{tikz}
\newcommand{\tikzcircle}[2][red,fill=red]{\tikz[baseline=-0.5ex]\draw[#1,radius=#2] (0,0) circle ;}% from https://tex.stackexchange.com/a/89827/102519
...
\setkomafont{part}{\rmfamily\Huge\bfseries\addfontfeature{LetterSpace=10}}
...
\definecolor{darkO}{rgb}{118, 45, 35}
\definecolor{darkof}{rgb}{195, 160, 153}

\definecolor{mytan}{rgb}{178, 54, 253}
\definecolor{mytanf}{rgb}{215, 145, 254}
...
%from https://tex.stackexchange.com/q/370384/102519
%and  https://tex.stackexchange.com/a/395858/102519
...
\DeclareMathOperator{\FCm}{\mathcal{F}\FCkern \mathcal{C}}
\newcommand{\FCkern}{%
  \mkern-2mu
  \mathchoice{}{}{\mkern0.2mu}{\mkern0.5mu}%
}
