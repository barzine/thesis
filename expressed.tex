...
\begin{figure}[!htbp]
    \centering
    \includegraphics[scale=0.65]{expressed/IBMexpression.png}
...
(See also respectively \cref{subsec:SpearmanCor}: \nameref{subsec:SpearmanCor} and
...
clustering analysis.
More precisely,
(as there are many available approaches and algorithms from which to pick)
...
and two tissues chosen at random share about 60 to 90\% of their pool of
...
\Cref{fig:noMitoNoRep4} in comparison of \Cref{fig:ExpGenePcoding1_withMito},
...
but also \enquote{transcriptional noise}~\mycite{rnaseq-2009},
