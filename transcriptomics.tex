...
\begin{itemize}[topsep=0pt,nosep]
%Feb 2016 -Uhlén
\item\hspace{-1mm}\fullcite{Uhlen:2016} In this review paper,
the authors present the results of \citet{Yu2015-uh} and \citet{Danielsson2015-cn}
discussed in following points.
They also compare the data released by the \gls{GTEx} consortium~\mycite{Bahcall2015-mh,GTEx_Consortium2015-si,Gibson2015-wh}
to their own dataset~(\uhlen\ data~\mycite{Uhlen2014,Uhlen2015}).
