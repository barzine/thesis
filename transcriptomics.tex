...
that are very prone to batch effects~\mycite{Irizarry2005-bs}
and are semiquantitative~\mycite{lee:2006}.
...
As discussed in \Cref{ch:expression},
...
comparisons.
(See \Crefu{subsec:PearsonVsSpearman}.)\mybr\
...
\begin{figure}[!htpb]
    \includegraphics[scale=0.9]{transcriptomics/T23EvolHighExp23P_noLog.pdf}\centering
    \vspace{-3mm}
...
it is only partial (see further \Cref{fig:cvEvol5DF}).\mybr\
...
there must be other gene categories contributing.\mybr\
...
Thus, this analysis may need to be rerun.\mybr\
...
by Uhlén \etal\ \mycite{Uhlen2014,Uhlen2015,Uhlen:2016}
...
in \WebFoCi{\egxa}{https://www.ebi.ac.uk/gxa/}{EBIgxa} and its corresponding widget
...
and which is partially shown here in \Cref{fig:TigerGenes,fig:hampelExp}.\mybr\
