...
\emph{\pc} (in \ens{76}),
\ie\ I specifically filtered out all the other genes even if they were observed.
...
Neither the \gls{gsea} or the \gls{goa} (See \Cref{ch:background})
...
and other (less differentiated) tissues may exhibit mitigated correlations.
...
the biological signal is mainly stronger than the technical variations.
...
In a few cases of the 23-tissues working set,
