...
\section{Consistency of processing methodology}\label{sec:Trans_consistentMethodo}
    ...
    \subsection{Reuse of processed data issues}\label{sec:Trans_reuseOfData}

    \subsection{Genome build and annotation impact}\label{sec:Trans_AnnotImpact}

\section{Results}\label{sec:Trans_Results}

    \subsection{Reproducibility of expression profile at tissue level}\label{sec:Trans_ReproExpresTissue}

        \subsubsection{Correlation}\label{sec:Trans_Tissue_Corr}
        \subsubsection{Clustering}\label{sec:Trans_Tissue_cluster}

    \subsection{Reproducibility of expression profile at gene level}\label{sec:Trans_ReproExpresGene}
