...
\TK{Several methods and parameters can be used for the clustering. Some are easy,
for other parameters: tried on each dataset first and if consensus, on the common
tissues}
