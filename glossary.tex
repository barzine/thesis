...
\newacronym{SAM}{SAM}{{s}equence {a}lignment/{m}ap}
...
It can be any nucleotides (usually either Adenosine (A), Cytosine (C), Guanine (G) or
...
is a database created by the Bioinformatics lab at Wilmer
...
\newglossaryentry{GTF}{name={GTF},
    description={Gene Transfer Format is a tab-delimeted
...
\newglossaryentry{GFF}{name={GFF},
    description={General Feature Format is a tab-delimited
...
an open-source interpreted programming langage developed by Larry Wall
...
high-level and interpreted programming langage developed by
...
interpreted programming langage Ross Ihaka and Robert Gentleman and the
