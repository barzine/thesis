...
an \textit{interpreted} programming langage developed by Larry Wall in 1987 to
easily handle textual information.}}


\newglossaryentry{cluster}{name={computer cluster}, description={Set of connected
