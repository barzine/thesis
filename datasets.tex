...
The data was downloaded from ProteomeXchange via the repository
\Pride{PXD000561}.
...
These data raw files were downloaded from \Proteomicsdb{PRDB000012}.
...
Unfortunately, when I started my study (and still at
the time of writing this thesis), the available \Rnaseq\ expression values
...
\textit{\color{darkgray}\Gtex\ v.1.4}  &
    ...
    \textit{\color{darkgray}>800,000}  & \textit{\color{darkgray}60.67 [4,214]}\\
\bottomrule
\end{tabular}
\end{table}
