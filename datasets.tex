...
\mycite{PeptideAtlas}, IDs: [PAe001768 --- PAe001778].
...
datasets\footnote{\egxa\ is still lacking the \dataset{Castle}.},
...
\mycite{Dillies2013}, \mycite{normSigCancerHelp}. For all these reasons,
...
with its set of default predefined arguments\footnote{Indeed, \soft{TopHat2} can
...
all its \emph{collapsed} exons. See \Cref{fig:Genelength-collapsedExons}.
...
As I discuss in \Cref{subsub:norm}, there are various strategies to estimate
...
On the other hand, \soft{HTSeq-count} provides only \emph{raw} counts. Hence, to
