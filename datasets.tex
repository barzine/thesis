...
for the proteome, \ie\ they are non-targeted high-throughput\footnote{These
technologies allow in theory to study the whole
...
For my thesis, I have to disregard a few studies as the raw data was not fitting
the reusability point.
Indeed, many times I came across (outdated) studies with ambiguous encoding
format for the raw data.
I was also unable to get the information from the original authors either.
...
are taking time, several \enquote{\emph{freezes}} of the data have been released.
My work is
