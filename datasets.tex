...
In this chapter, I review the publicly available (for research) data
I use within my thesis
and explain how they have been reprocessed.
Besides the results I report in this thesis subsequent chapters,
...
Indeed, many times I came across studies with ambiguous encoding
...
that may be integrated together in an atlas.
...
\vspace*{-0.2in}
This dataset, first created in 2010, has been released in
...
I have included this data
as it was for an extended time
the most extensive freely available \Rnaseq\ dataset of human tissues.
Hence, it has been referenced many times in the literature since its release.
...
\subsection{GTEx data}\label{subsec:gtexPresentation}
\vspace*{-0.1in}
...
datasets (it is still lacking the \castle\ \etal\ dataset.),
...
with \irap's proposed default splice-aware mapper
