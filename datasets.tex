...
\href{http://www.peptideatlas.org/}{www.peptideatlas.org}}~\mycite{PeptideAtlas},
...
Dr Nuno Fonseca retrieved and processed the \gtex\ dataset (\hg{38.p1}
...
\begin{figure}
    \includegraphics[scale=1]{datasets/collapsedExons.pdf}\centering
...
\subsection{MS-based (shotgun) proteome data processing}

After retrieval of the data from \gls{Pride} and \gls{Proteomicsdb},
Dr James Wright reprocessed the three proteome \ms-based datasets.
...
The sequence database is a critical element of the \ms\ pipeline and thus, it has
been carefully designed. It combines six different parts, three based on known
protein sequences and three other covering possible new protein candidates.
...
\href{http://www.uniprot.org/}{\gls{Uniprot}}\footnote{%
\gls{Uniprot} --- \href{http://www.uniprot.org/}{http://www.uniprot.org/}}%
~\mycite{UniProt2017} (in its May 2014 version); common contamination protein
sequences (from the Max Planck Institute of
Biochemistry\footnote{Contamination sequences ---
\href{http://maxquant.org/contaminants.zip}{http://maxquant.org/contaminants.zip}})
and \gls{HLA} sequences\footnote{\gls{HLA} sequences ---
\href{http://www.ebi.ac.uk/ipd/imgt/hla/download.html}%
{http://www.ebi.ac.uk/ipd/imgt/hla/download.html}}. The sources for potential
...
\href{http://bioinf.uni-greifswald.de/augustus/}{\soft{AUGUSTUS}}\footnote{%
\soft{AUGUSTUS} --- \href{http://bioinf.uni-greifswald.de/augustus/}%
{http://bioinf.uni-greifswald.de/augustus/}}~\mycite{Stanke2004}; a set of
two-consensus predictions (December 2013) from \href{http://pseudogene.org/}%
{\soft{Pseudogene.org}}\footnote{\soft{Pseudogene.org} ---
\href{http://pseudogene.org/}{http://pseudogene.org/}}~\mycite{pseudogenesOrg}
and three-frame translated \Rnaseq\ transcript sequences. These \Rnaseq\
transcript sequences includes an \gls{Ensembl} model (built itself
on \ibm), models created with
\href{http://software.broadinstitute.org/software/scripture/}{\soft{Scripture}}%
\footnote{\soft{Scripture} ---
\href{http://software.broadinstitute.org/software/scripture/}%
{http://software.broadinstitute.org/software/scripture/}}~\mycite{scripture}
by the Kellis lab (also built on \ibm) and finally models by Caltech and CSHL
based on different \gls{ENCODE} (created with \soft{Cufflinks}).
