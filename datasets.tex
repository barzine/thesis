...
\citet{Burge} is one example of study that I unfortunately had to dismiss.
...
from where I have retrieved the single-end and paired-end mono-tissue samples.
...
The project was first explained in~\citet{GTEx2013}. It consists to quickly collect
...
uniformly the three datasets from the raw spectra up to the normalisation of the
...
(L) residues were converted to (J)\footnote{J is one of the letter
...
studies findings --- apart for~\citet{PandeyData}.
