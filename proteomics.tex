...
same-tissue interstudy correlations.}
...
\section{New quantification method}
...
\begin{figure}[!htbp]
    ...
    See \Cref{eq:PPKM}, which is close to \Cref{eq:rpkm-fx}.
    ...
    The new quantification method was designed for \Cref{ch:Integration} in particular;
...
(see \Cref{eq:Top3} and \Cref{subsubsec:protQuantLB}).
...
I have also checked the presence of \gls{OR} in the \pandey\ data
...
in the \emph{Baseline expression} of \WebFoCi{\egxa}{https://www.ebi.ac.uk/gxa/}{NAR2015}
...
Besides, across the different tissues and datasets,
about half of the proteins are consistently observed in the same tissues at least
twice.
I provide as digital supporting data the list of the \gls{TS} and
ubiquitous (also known as \emph{housekeeping}) proteins.
...
The processing has a significant impact on protein identification.
In our version of \pandey\ data,
I have found 534 housekeeping (ubiquitous) proteins and 1,491 specific proteins.
...
about twice as many proteins than the first one (Top3~\mycite{Silva-Top3}).
...
I have found 2,057 ubiquitous and 2,640 \gls{TS} proteins
for the \PPKM\ quantification of the \pandey\ data.
