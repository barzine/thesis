...
\begin{figure}[!htpb]
    \includegraphics[scale=0.7]{proteomics/scatterplot/3D/heartCutlerPandey.png}\centering
...
\begin{figure}[!htpb]
    \includegraphics[scale=0.7]{proteomics/scatterplot/3D/heartKusterPandey.png}\centering
...
\begin{figure}[!htpb]
    \includegraphics[scale=0.7]{proteomics/scatterplot/2D/PlacentaKusterPandey.png}\centering
...
\begin{figure}[!htpb]
    \includegraphics[scale=0.7]{proteomics/scatterplot/2D/PancreasAdrenalKuster.png}\centering
...
\begin{figure}[!htpb]
    \includegraphics[scale=0.7]{proteomics/scatterplot/2D/PancreasKusterAdrenalPandey.png}\centering
...
\begin{figure}[!htpb]
    \includegraphics[scale=0.9]{proteomics/heatmap2DproteinSpearmanT14_PPKM.png}\centering
    \caption[Heatmap of the 14 common tissues between Pandey and Kuster
