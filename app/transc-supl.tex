...
\begin{figure}[htpb]
    ...
    \caption[Heatmap no Mito]{\label{fig:noMitoRep4T}\textbf{No mito, all rep, 4T}}
\end{figure}
...
\caption[Distribution of the Pearson correlation of matched and unmatched tissue
pairs across the 5 studies]{\label{fig:distribPearsCorr}\textbf{Distribution
of the Pearson correlation of matched and unmatched tissue pairs across the 5
studies.}}
\end{figure}
