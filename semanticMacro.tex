...
\newcommand*\gene[1]{\textit{\textsc{#1}}}
...
\newcommand*\chemForm[1]{\ensuremath{\mathrm{#1}}}


%% identifiers
\newcommand*\ENA[1]{\gls{ENA} \gls{ID}: \textnormal{#1}}
\newcommand*\ArrayExpress[1]{\gls{ArrayExpress} \gls{ID}: \textnormal{#1}}
\newcommand*\dbGaP[1]{\gls{dbGaP} \gls{ID}: \textnormal{#1}}
\newcommand*\Pride[1]{\gls{Pride} \gls{ID}: \textnormal{#1}}
\newcommand*\Proteomicsdb[1]{\gls{Proteomicsdb} \gls{ID}: \textnormal{#1}}
...
\newcommand*\phd{Ph.D.}
%\newcommand*\cpv[1]{\colorbox{Goldenrod}{#1}}
%\newcommand*\cpv[1]{\begin{mdframed}[hidealllines=true,backgroundcolor=Dandelion]#1\end{mdframed}}
\newcommand*\cpv[1]{\cbcolor{orange}\cbstart{}{#1} \cbend}
\newcommand*\cpvD{\cbcolor{red} \cbdelete}
...
\newcommand*\psm{\gls{PSM}}
\newcommand*\psms{\glspl{PSM}}
\newcommand*\PPKM{\gls{PPKM}}
\newcommand*\PPKMs{\glspl{PPKM}}
...
\newcommand*\karlis{Dr K\={a}rlis Freivalds}
\newcommand*\juris{Dr Juris Viksna}
...
\newcommand*\pval{p-value (see \Cref{p-value})}
\newcommand*\pvalue[1]{p-value ${#1}$}
\newcommand*\Welchttest{Welch's Two Sample \ttest}
\newcommand*\studenttest{Student's Two Sample \ttest}
\newcommand*\qval{\textit{q}-value (see \Cref{qvalP} and \Cref{q-value})}
...
\newcommand*\mybr{\\ \vspace{-\baselineskip}}



%url to different part of the github repo for this thesis
\newcommand*\addressToirapConfFiles{%
\href{https://github.com/barzine/phd-analyses/tree/master/chapter2/irap-configuration-files}%
{my personal Github repository}\footnote{%
\href{https://github.com/barzine/phd-analyses/tree/master/chapter2/irap-configuration-files}%
{https://github.com/barzine/phd-analyses/tree/master/chapter2/irap-configuration-files}}}

\newcommand*\github{\href{https://github.com/barzine/phd-analyses}%
{https://github.com/barzine/phd-analyses}}
...
\newcommand*\Urinarybladder{\tissue{Urinarybladder}}
\newcommand*\Bladder{\tissue{Urinarybladder}}
