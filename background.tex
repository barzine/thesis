...
Tag strategies label the proteins (before or after extraction)
...
their associated tools also tend to dominate the \ms{}-based proteomic bioinformatics~\mycite{Lee2015-di}.
In the following pages,
from the many possible approaches and concepts,
...
For sequenced organisms, peptide identification approaches favour \gls{PMF}
over \emph{de novo} peptide sequencing,
as the latter is very cumbersome and time-consuming.
\gls{PMF}~\mycite{Henzel2003-er,Blueggel2004-qc} requires
to match the molecular mass and fragmentation profile
of the raw data to known (or theoretical) spectra from peptide databases.
Many search engines exist for \gls{MS/MS},
see \citet{Griss2016,Shteynberg2013,Eng2011} for reviews.
Furthermore\label{seg:moreAlgoisbetter},
combining the results of several search algorithms improve
studies final outcomes\mycite{Sadygov2004-nl,Eng2011,Shteynberg2013,Griss2016}.

\minisec{Spectra matching (or spectral library search)}
...
is the presence of batch effects.

%%%% a completer ici aussi
%Other biases
