...
{Transcriptome exploration with RNA sequencing \quad}
...
\subsubsection{Adapter ligation, PCR amplification and size selection \quad}
...
\subsection{A typical bioinformatic workflow for \Rnaseq\ study}\label{sub;RNAseqworflow}
...
\mycite{readMappingDef}. Tools as \soft{TopHat2} contributes to this
locution vagueness.
...
\section{Proteome exploration with Mass spectrometry \quad}
...
\mycite{Bruce2013} and may be incompatible with a number of extraction protocols.
...
\href{htpp://www.perseus-framework.org}{http://www.perseus-framework.org}}
\mycite{perseus2016} for the downstream data analysis part). Moreover, these
...
\subsubsection[Peptide identification]{From peptide identification \ldots}
...
\gls{MS/MS} search engines, see \mycite{Griss2016,Shteynberg2013,Eng2011}
for reviews.
...
resolve the atomic composition of the peptides (for example see \mycite{Nitpick}).
