...
proteins can comprise twenty different amino acids (\Cref{sec:aa}),
...
that is linked to the pentose carbon annotated 3'.~\mycite{Morris2016-qv,molBiolCell,Callen2005-ik}
Pentoses are monosaccharides containing a chain of five carbons.
When the pentose is part of a nucleotide,
these carbons are annotated from 1' to 5'
to avoid confusion with the carbons of nitrogenous cycles.

\vspace{-2mm}
\begin{figure}[!htpb]
    \includegraphics[scale=0.55]{background/DNA-RNAstruct1.png}\centering
    \vspace{-2mm}
...
\begin{figure}[!htbp]
    \includegraphics[scale=0.70]{background/dogma.pdf}\centering
...
Batch effects are artefactual and due to all the variables that the investigator can not control
