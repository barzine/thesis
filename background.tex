...
pipelines integrate many different combinations of these tools~\mycite{Vitek2009}.
...
Markov chain models~\mycite{Gagniuc2017-nj} are often used to mimic to the closest
...
\eg\ for an overview of the proteome landscape.~\mycite{Kall2008-tf}
...
\enquote{one-hit wonder} proteins~\mycite{Huang2012-nr,He2016-yi}.
On the other hand,
...
have been reviewed in the literature~\mycite{Huang2012-nr,Serang2012-jl}.
...
as more peptides are characterised per protein~\mycite{Huang2012-nr,Audain2017-jj}.
...
\subsection{Gene set enrichment analysis (GSEA)}\label{sec:gseaPresentation}
