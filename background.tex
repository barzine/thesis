...
called \emph{Sequencing-by-Synthesis}~\mycite{seqBySynth},
is the same.
...
and as each \dNTPs\ has a tag
that fluoresces at its own characteristic wavelength,
the emitted signal allows \emph{calling} (\ie\ identifying)
the new nucleotide incorporated by each cluster.
The signal intensity and wavelength are recorded
for later base calling and accuracy estimation.
