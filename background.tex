...
Subsequently,
the latter also present an extensive range of physicochemical properties.
...
in a given cell or tissue type.~\mycite{Morris2016-qv,Callen2005-ik}
...
\vspace{-2mm}
\begin{figure}[!htpb]
    \includegraphics[scale=0.50]{background/DNA-RNAstruct1.png}\centering
    \vspace{-2mm}
...
\begin{figure}%[!htbp]
    \includegraphics[scale=0.75]{background/dogma1.pdf}\centering
