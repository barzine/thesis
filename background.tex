...
A Most of the search engines return multiple scores.
...
improves the results both as accuracy and
sensitivity~\mycite{Granholm2014-cw,Xu2013-si,Tu2015-iy,The2016-dq,Wright2012-od}
...
or as a post-processing step to the \gls{TDA}.

Two other significance measures for \psm\ validation used by algorithms
infering proteins identity are q-values and \gls{PEP}.
...
\glsentrydesc{IBAQ} (\gls{IBAQ}) is a label-free method based on peak intensity.
